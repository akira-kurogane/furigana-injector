...
class NS_NO_VTABLE iYomikataDictionary : public nsISupports {
 public: 
  ...
  NS_IMETHOD LoadFromFile(nsILocalFile *dict_file_path, PRBool *_retval) = 0;
...
/* Header file */
class _MYCLASS_ : public iYomikataDictionary
{
public:
  NS_DECL_ISUPPORTS
...
/* Implementation file */
NS_IMPL_ISUPPORTS1(_MYCLASS_, iYomikataDictionary)
...
/* boolean loadFromFile (in nsILocalFile dict_file_path); */
NS_IMETHODIMP _MYCLASS_::LoadFromFile(nsILocalFile *dict_file_path, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* AString findExact (in AString search_word); */
NS_IMETHODIMP _MYCLASS_::FindExact(const nsAString & search_word, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* AString findLongestMatch (in AString search_word, out short match_length); */
NS_IMETHODIMP _MYCLASS_::FindLongestMatch(const nsAString & search_word, PRInt16 *match_length, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
